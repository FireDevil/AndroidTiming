...
/**
 * Created by Antec on 23.03.2014.
 */
public class SwipeToDismissListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link SwipeToDismissListener} to inform its client
     ...
     */
    public SwipeToDismissListener(ListView listView, DismissCallbacks callbacks) {
     ...
     * to this listener. This will ensure that this {@link SwipeToDismissListener} is
